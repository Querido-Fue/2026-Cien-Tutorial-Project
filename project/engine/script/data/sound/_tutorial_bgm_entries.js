...
const BGM_DEFAULT_VOLUME_SCALE = 0.7;
...
export const TUTORIAL_BGM_ENTRIES = Object.freeze([
    createTutorialAudioEntry({
        ...
        bus: 'bgm', loop: true, defaultVolume: 0.72 * BGM_DEFAULT_VOLUME_SCALE, polyphony: 1,
    ...
    createTutorialAudioEntry({
        ...
        bus: 'bgm', loop: true, defaultVolume: 0.78 * BGM_DEFAULT_VOLUME_SCALE, polyphony: 1,
        cooldownSeconds: 0, required: true
    }),
    createTutorialAudioEntry({
        ...
        bus: 'bgm', loop: true, defaultVolume: 0.74 * BGM_DEFAULT_VOLUME_SCALE, polyphony: 1,
        cooldownSeconds: 0, required: true
    }),
    createTutorialAudioEntry({
